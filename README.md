  ...
  <k-dialog as="loginDialog">
    ...
    <form class="pure-form pure-form-stacked" method="post" action="/login" data-router-ignore="">
      <fieldset class="pure-u-1-1">
        ...
        <div class="pure-control-group left">
          <label for="password">{{t('Password')}}<a data-router-ignore="" class="pull-right smaller italic gray margin-top-7 t" href="/passwork-reset">{{t('Need password remainder?')}}</a></label>
